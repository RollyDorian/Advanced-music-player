...
class AudioApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Продвинутый плеер')
        self.initUI()
    ...
    def initUI(self):
        ...
        self.play_button.move(50, 200)
        self.stop_button.move(50, 250)
        self.file_path_button.move(50, 300)

        self.progress_bar = QProgressBar(self)
        self.progress_bar.setRange(0, 100)
        self.progress_bar.move(20, 150)
        self.progress_bar.resize(200, 15)

        self.time_label = QLabel("00:00 / 00:00", self)
        self.time_label.move(30, 160)
        ...
        self.save_preset_name.move(250, 10)
        self.save_preset_button.move(400, 10)
        self.delete_preset_button.move(500, 10)
